...
- Fixed [a bug](https://github.com/Leafwing-Studios/leafwing-input-manager/issues/407) related to incorrect axis data in `Chord` when not all buttons are pressed.
