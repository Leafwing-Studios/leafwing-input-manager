...
pub mod prelude {
    ...
    pub use crate::input_like::mouse_wheel::MouseWheelAxis;
    pub use crate::input_like::mouse_wheel::MouseWheelDirection;
    pub use crate::input_like::virtual_dpad::VirtualDPad;
    pub use crate::input_like::InputLikeObject;
